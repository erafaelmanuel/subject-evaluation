...
public class StudentResultController implements Initializable {
    ...
    public void listener(List<io.erm.ees.model.Student> studentList) {
        OBV_STUDENT_LIST.clear();
        loadResult(studentList);
    }

    private void loadResult(List<io.erm.ees.model.Student> studentList) {
        for (io.erm.ees.model.Student s : studentList) {
    ...
    protected void onClickConfirm(ActionEvent event) {
        ...
        io.erm.ees.model.Student student = studentDao.getStudentById(id);
