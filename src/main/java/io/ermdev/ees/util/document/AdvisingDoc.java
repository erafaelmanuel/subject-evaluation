...
public class AdvisingDoc {
    ...
    private final List<io.ermdev.ees.model.recursive.Subject> SUBJECT_LIST = new ArrayList<>();
    ...
    public void addSubject(io.ermdev.ees.model.recursive.Subject subject) {
    ...
    public void addSubject(List<io.ermdev.ees.model.recursive.Subject> subjectList) {
    ...
    private PdfPTable getTable() throws DocumentException, IOException {
        ...
        for (int i = 0; i < 14; i++) {
            if (size > i) {
                io.ermdev.ees.model.recursive.Subject subject = SUBJECT_LIST.get(i);
