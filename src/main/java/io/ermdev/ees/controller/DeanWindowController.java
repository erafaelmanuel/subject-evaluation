...
import io.ermdev.ees.model.v2.Subject;
import io.ermdev.ees.stage.DeanStage;
import io.ermdev.ees.stage.window.PopOnExitWindow;
    ...
    protected void onClickAdd() {
        ...
        if(index > -1) {
            ...
            if(!(record.getMark().equalsIgnoreCase("PASSED")
                ...
                for (io.ermdev.ees.model.Subject subject : curriculumDao.getSubjectList(
