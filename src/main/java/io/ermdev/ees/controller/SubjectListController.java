...
public class SubjectListController implements Initializable {
    ...
    protected void onClickAdd(ActionEvent event) {
        ...
        if (index > -1) {
            ...
            stage.callback(new io.ermdev.ees.model.Subject(subject.getId(), subject.getName(), subject.getDesc(),
    ...
    private void loadSubject(List<io.ermdev.ees.model.Subject> subjectList) {

        SUBJECT_LIST.clear();
        for (io.ermdev.ees.model.Subject s : subjectList)
