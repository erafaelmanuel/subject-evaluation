...
import io.ermdev.ees.legacy.dao.SectionDao;
import io.ermdev.ees.legacy.dao.StudentDao;
...
import io.ermdev.ees.legacy.model.recursive.Student;
import io.ermdev.ees.legacy.stage.StudentResultStage;
...
public class StudentResultController implements Initializable {
    ...
    public void listener(List<io.ermdev.ees.legacy.model.Student> studentList) {
        OBV_STUDENT_LIST.clear();
        loadResult(studentList);
    }

    private void loadResult(List<io.ermdev.ees.legacy.model.Student> studentList) {
        for (io.ermdev.ees.legacy.model.Student s : studentList) {
    ...
    protected void onClickConfirm(ActionEvent event) {
        ...
        io.ermdev.ees.legacy.model.Student student = studentDao.getStudentById(id);
