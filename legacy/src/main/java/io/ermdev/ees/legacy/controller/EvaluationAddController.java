...
import io.ermdev.ees.legacy.helper.DateHelper;
import io.ermdev.ees.legacy.helper.DbFactory;
import io.ermdev.ees.legacy.helper.EvaluationHelper;
...
import io.ermdev.ees.legacy.stage.EvaluationAddStage;
...
public class EvaluationAddController implements Initializable, AdvisingDoc.CreationListener {
    ...
    protected void onChooseFilter() {
        ...
        final List<io.ermdev.ees.legacy.model.Subject> list = new ArrayList<>();
        final List<io.ermdev.ees.legacy.model.Subject> tempList = new ArrayList<>();
        if(index == -1) return;
        ...
        new Thread(() -> {
            if (index == 0) {
                ...
                for(io.ermdev.ees.legacy.model.Subject subject : tempList) {
