package io.ermdev.ees.legacy.util.document;
...
public class AdvisingDoc {
    ...
    private final List<io.ermdev.ees.legacy.model.recursive.Subject> SUBJECT_LIST = new ArrayList<>();
    ...
    public void addSubject(io.ermdev.ees.legacy.model.recursive.Subject subject) {
        SUBJECT_LIST.add(subject);
    }

    public void addRawSubject(io.ermdev.ees.legacy.model.Subject subject) {
    ...
    public void addSubject(List<io.ermdev.ees.legacy.model.recursive.Subject> subjectList) {
        SUBJECT_LIST.addAll(subjectList);
    }

    public void addRawSubject(List<io.ermdev.ees.legacy.model.Subject> subjectList) {
    ...
    private PdfPTable getTable() throws DocumentException, IOException {
        ...
        for (int i = 0; i < 14; i++) {
            if (size > i) {
                io.ermdev.ees.legacy.model.recursive.Subject subject = SUBJECT_LIST.get(i);
