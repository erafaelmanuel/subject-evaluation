...
public class EESApplication extends Application implements ConfigurationStage.OnFinishListener, LoginStage.OnLoginListener,
    ...
    public void init() throws Exception {
        SpringApplication.run(EESApplication.class);
    }
